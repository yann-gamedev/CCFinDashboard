    ...
    <form @submit.prevent="submitTransaction" class="space-y-4">
      ...
      <div>
        ...
        <input type="text" v-model="title" placeholder="Cth: Beli Kopi" 
               class="w-full p-2.5 border border-slate-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm">
      </div>
      ...
      <div class="grid grid-cols-2 gap-4">
        ...
        <div>
          ...
          <select v-model="category" class="w-full p-2.5 border border-slate-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm bg-white">
      ...
      <button type="submit" 
              class="w-full mt-4 bg-slate-900 hover:bg-slate-800 text-white font-medium py-2.5 rounded-lg transition-colors text-sm">
        Simpan Transaksi
      </button>
    </form>
  </div>
